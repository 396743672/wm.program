...
package org.github.ycg000344.weiming.application.dictmanager.configuration;
...
public class DruidConfig {
	...
	@Value("${weiming.dictmanager.druid.loginname}")
	private String loginName;
	@Value("${weiming.dictmanager.druid.password}")
